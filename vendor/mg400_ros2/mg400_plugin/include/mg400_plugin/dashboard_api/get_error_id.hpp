...
#ifndef __MG400_PLUGIN_DASHBOARD_API_GET_ERROR_ID_HPP__
#define __MG400_PLUGIN_DASHBOARD_API_GET_ERROR_ID_HPP__
...
{
class GetErrorID final : public mg400_plugin_base::DashboardApiPluginBase
{
public:
  using ServiceT = mg400_msgs::srv::GetErrorID;
