  ...
  prefix_(this->declare_parameter("prefix", ""))
{
  ...
  this->ui_->j1_slider->setValue(
    std::abs(mg400_common::kinematics::J1_MIN) /
    (mg400_common::kinematics::J1_MAX - mg400_common::kinematics::J1_MIN) * 1000);
  this->ui_->j2_slider->setValue(
    std::abs(mg400_common::kinematics::J2_MIN) /
    (mg400_common::kinematics::J2_MAX - mg400_common::kinematics::J2_MIN) * 1000);
  this->ui_->j3_slider->setValue(
    std::abs(mg400_common::kinematics::J3_MIN) / (
      mg400_common::kinematics::J3_MAX - mg400_common::kinematics::J3_MIN) * 1000);
  this->ui_->j4_slider->setValue(
    std::abs(mg400_common::kinematics::J4_MIN) /
    (mg400_common::kinematics::J4_MAX - mg400_common::kinematics::J4_MIN) * 1000);
...
void MainWindow::centerBtn()
{
  ...
  int j1_center = get_center(
    mg400_common::kinematics::J1_MIN, mg400_common::kinematics::J1_MAX);
  int j2_center = get_center(
    mg400_common::kinematics::J2_MIN, mg400_common::kinematics::J2_MAX);
  int j3_center = get_center(
    mg400_common::kinematics::J3_MIN, mg400_common::kinematics::J3_MAX);
  int j4_center = get_center(
    mg400_common::kinematics::J4_MIN, mg400_common::kinematics::J4_MAX);
...
{
  char txt[50];
  this->j1_ = mg400_common::kinematics::J1_MIN +
    (mg400_common::kinematics::J1_MAX - mg400_common::kinematics::J1_MIN) * value * 1e-3;
...
{
  char txt[50];
  this->j2_ = mg400_common::kinematics::J2_MIN +
    (mg400_common::kinematics::J2_MAX - mg400_common::kinematics::J2_MIN) * value * 1e-3;
...
{
  char txt[50];
  this->j3_ = mg400_common::kinematics::J3_MIN +
    (mg400_common::kinematics::J3_MAX - mg400_common::kinematics::J3_MIN) * value * 1e-3;
...
{
  char txt[50];
  this->j4_ = mg400_common::kinematics::J4_MIN +
    (mg400_common::kinematics::J4_MAX - mg400_common::kinematics::J4_MIN) * value * 1e-3;
