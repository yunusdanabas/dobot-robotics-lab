"""
viz_mg400.py — Small live visualizer for MG400 hardware scripts.
...
class RobotViz:
    """Forward commanded or polled MG400 poses to a Qt/pyqtgraph process."""
    ...
    def attach(self, move_api) -> None:
        """Patch MovJ and MovL so command targets appear in the plot."""
...
def _viz_process(queue) -> None:
    ...
    hard_limits = {"x": (0, 440), "y": (-220, 220), "z": (0, 150)}
    safe_bounds = {"x": (60, 400), "y": (-220, 220), "z": (5, 140)}
    ...
    class _Window(QMainWindow):
        def __init__(self, q):
            ...
            self._xy.setXRange(-50, 470)
            self._xy.setYRange(-250, 250)
            ...
            self._xz.setXRange(-50, 470)
            self._xz.setYRange(-20, 170)
