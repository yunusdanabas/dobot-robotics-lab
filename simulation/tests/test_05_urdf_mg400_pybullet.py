"""MG400 URDF pose hook in PyBullet. Run as a script; unittest discover skips these."""
...
def main():
    ...
    print(f"=== MG400 URDF in PyBullet (GUI={'on' if gui else 'off'}) ===")

    from sim_mg400 import SimMG400

    try:
        sim = SimMG400(backend="pybullet", gui=gui)
